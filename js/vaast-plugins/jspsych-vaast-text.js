...
***************************************************************/
 ...
 jsPsych.plugins['vaast-text'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html_str += "<div style='height: 100vh; display: flex; justify-content: center; align-items: center;z-index:1; color: #000000; font-size: "+trial.font_sizes[trial.position]+"px' id='jspsych-vaast-stim'>"+trial.stimulus+"</div>";
